...
import in.udaan17.android.databinding.ActivityFirstRunBinding;

public class FirstRunActivity extends AppCompatActivity {
  private static int SPLASH_TIME_OUT = 4000;
  private static int ANIMATE_IMAGE = 2000;
  
  private ActivityFirstRunBinding dataBinding;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (!firstTime) {
      ...
      this.dataBinding = DataBindingUtil.setContentView(this, R.layout.activity_first_run);
      ...
      new Handler().postDelayed(new Runnable() {
        ...
        public void run() {
          ObjectAnimator scaleDown = ObjectAnimator.ofPropertyValuesHolder(
              FirstRunActivity.this.dataBinding.udaanLogo,
